...
void MyWindow::start()
{
	...
	{
		TimeMiliSeconds = clock.restart().asMicroseconds();             // берем час в м≥л≥секундах в≥д початку гри
		if (TimeMiliSeconds > SPEED) TimeMiliSeconds = SPEED;           // регулюЇм швидк≥сть гри
